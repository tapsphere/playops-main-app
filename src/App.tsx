...
import { TonAuthHandler } from "./components/TonAuthHandler";
...
const AppContent = () => {
  const { showOnboarding, userRole, isLoading } = useAuth();
  ...
  // if (showOnboarding && !location.pathname.startsWith('/auth')) {
  if (showOnboarding) {
    switch (userRole) {
      case 'creator':
      ...
      default: // player or any other role
      ...
      <Routes>
        ...
        <Route path="/platform" element={<PlatformLayout />}>
          <Route path="creator" element={<CreatorDashboard />} />
                      <Route path="brand" element={<BrandDashboard />} />          <Route path="admin" element={<AdminDashboard />} />
